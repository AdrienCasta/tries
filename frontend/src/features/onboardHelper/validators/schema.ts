import { z } from "zod";
import { PROFESSION_CODES } from "../constants/professions";
import { ALL_FRENCH_COUNTIES } from "../constants/frenchCounties";
import { RESIDENCE_COUNTRY_CODES } from "../constants/residenceCountries";
...
export const onboardHelperSchema = z.object({
  ...
  rppsNumbers: z.record(z.string(), z.string()),
  birthdate: z
    .string()
